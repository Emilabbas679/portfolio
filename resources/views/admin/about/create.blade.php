...
@section('content')
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-sm-flex align-items-center justify-content-between mb-4">
            <h6 class="m-0 font-weight-bold text-primary">Add About</h6>
        </div>
        <div class="card-body">
            <div class="col-md-10 offset-md-1">
                <form class="user" method="POST" onsubmit="return validateForm()" name="createAbout" action="{{ route('about.store') }}" enctype="multipart/form-data">
                    @csrf
...
@push('js')
    ...
    <script>
        function validateForm() {
            var img = document.forms["createAbout"]["img"].value;
            if(img == ''){
