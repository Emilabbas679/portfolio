...
@section('content')
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-sm-flex align-items-center justify-content-between mb-4">
            <h6 class="m-0 font-weight-bold text-primary">Edit {{ $service->title }}</h6>
        </div>
        <div class="card-body">
            <div class="col-md-10 offset-md-1">
                <form class="user" method="POST" action="{{ route('service.update', $service->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                                ...
                                <div class="form-group form-row">
                                    ...
                                    <div class="col-md-10">
                                        <textarea name="text[{{$locale->code}}]" id="text-{{$locale->code}}" cols="30" rows="10" class='textarea'>
                                            {{$service->getTranslation('text', $locale->code)}}
                                        </textarea>
                                        @error('text')
                    ...
                    <div class="form-group form-row">
                        ...
                        <div class="col-md-10">
                            <input id="title" type="text" class="form-control @error('title') is-invalid @enderror"
                                   name="title" value="{{$service->title}}" placeholder="Title">
                    ...
                    <div class="form-group form-row">
                        ...
                        <div class="col-md-10">
                            <input id="icon" type="text" class="form-control @error('icon') is-invalid @enderror"
                                   name="icon" value="{{$service->icon}}" placeholder="Icon">
                            <span class="invalid-feedback name-error-js"></span>
